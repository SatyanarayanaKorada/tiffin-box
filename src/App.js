...
const Hero = () => {
  return (
    <section className="relative h-screen min-h-[700px] flex items-center bg-brand-dark">
      ...
      <div className="i5i absolute top-0 right-0 w-1/2 h-full hidden md:block">
        {/* { <img 
          src="https://raw.githubusercontent.com/SatyanarayanaKorada/tiffin-box/refs/heads/main/src/assets/image.png"
    ...
    <section className="py-24 bg-brand-gray relative">
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <img 
              src="https://cdn.pixabay.com/photo/2015/08/16/12/38/man-890885_640.jpg" // Placeholder image of chef from design
              alt="Chef Jomon"
